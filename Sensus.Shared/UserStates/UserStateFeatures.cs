...
{
    public abstract class UserStateFeatures
    {

        /// <summary>
        /// Settings for serializing UserStateFeatures objects
        /// </summary>
        ...
        public static UserStateFeatures FromJSON(string json)
        {
            // null userStateFeatures properties in the json come from a few places:  a reference-type property that is 
            ...
            // third case the property will have its default value. be aware that value-type userStateFeatures type properties
            ...
            UserStateFeatures userStateFeatures = null;

            try
            {
                userStateFeatures = JsonConvert.DeserializeObject<UserStateFeatures>(json, JSON_SERIALIZER_SETTINGS);
            }
            catch (Exception ex)
            {
                SensusServiceHelper.Get().Logger.Log("Failed to convert JSON to userStateFeatures:  " + ex.Message, LoggingLevel.Normal, typeof(UserStateFeatures));
            }

            return userStateFeatures;
        }
        ...
        /// <summary>
        /// Unique identifier for the current <see cref="UserStateFeatures"/>, unique across all data generated by all Sensus apps.
        /// </summary>
        ...
        /// <summary>
        /// Date and time at which a data element from the UserState was read.
        /// </summary>
        ...
        /// <summary>
        /// A unique identifier for the <see cref="Protocol"/> that generated this <see cref="UserStateFeatures"/>.
        /// </summary>
        ...
        /// <summary>
        /// Whether or not this <see cref="UserStateFeatures"/> has been run through an anonymizer.
        /// </summary>
        ...
        /// <summary>
        /// The identifier for the build of Sensus that generated this userStateFeatuers.
        /// </summary>
        ...
        /// <summary>
        /// The identifier for the participant that generated this userStateFeatures. This will be null if 
        ...
        protected UserStateFeatures(DateTimeOffset timestamp)
        {
